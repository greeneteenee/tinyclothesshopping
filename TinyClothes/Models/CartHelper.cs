...
namespace TinyClothes.Models
{
    ...
    public static class CartHelper
    {
        ...
        public static void Add(Clothing c, IHttpContextAccessor http)
        {
            ...
            string data = JsonConvert.SerializeObject(clothes);  //newtonsoft.com
        ...
        /// <summary>
        /// Returns all clothing currently stored in the users cookie. If no items are present an empty list is returned.
        /// </summary>
